...
CREATE TABLE `Carro` (
    ...
    `StatusCarro_idStatusCarro` INTEGER NOT NULL,
    `TipoCarro_idTipoCarro` INTEGER NOT NULL,
    `modelo` VARCHAR(255) NOT NULL,
    `cor` VARCHAR(255) NOT NULL,
    `placa` VARCHAR(10) NOT NULL,
    `capacidade` INTEGER NOT NULL,

    INDEX `fk_carro_status`(`StatusCarro_idStatusCarro`),
    INDEX `fk_carro_tipo`(`TipoCarro_idTipoCarro`),
    PRIMARY KEY (`idCarro`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;

-- CreateTable
CREATE TABLE `CategoriaMensagemOuvidoria` (
    `idCategoriaMensagemOuvidoria` INTEGER NOT NULL AUTO_INCREMENT,
    `nome_categoria` ENUM('DENUNCIA', 'SOLICITACAO', 'SUGESTAO', 'RECLAMACAO', 'ELOGIO') NOT NULL,
...
-- CreateTable
CREATE TABLE `IntervaloDatas` (
    `idIntervaloDatas` INTEGER NOT NULL AUTO_INCREMENT,
    `Curso_idCurso` INTEGER NULL,
    `Evento_idEvento` INTEGER NULL,
    `data_inicio` DATE NOT NULL,
    `data_fim` DATE NOT NULL,

    INDEX `fk_intervalo_curso`(`Curso_idCurso`),
    INDEX `fk_intervalo_evento`(`Evento_idEvento`),
    PRIMARY KEY (`idIntervaloDatas`)
) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci;
...
CREATE TABLE `MensagemOuvidoria` (
    ...
    `CategoriaMensagemOuvidoria_idCategoriaMensagemOuvidoria` INTEGER NOT NULL,
    ...
    INDEX `fk_msg_categoria`(`CategoriaMensagemOuvidoria_idCategoriaMensagemOuvidoria`),
...
CREATE TABLE `Solicitacao` (
    ...
    `TipoSolicitacao_idTipoSolicitacao` INTEGER NOT NULL,
    `Usuario_idUsuario` INTEGER NOT NULL,
    ...
    INDEX `fk_solicitacao_tipo`(`TipoSolicitacao_idTipoSolicitacao`),
...
CREATE TABLE `SolicitacaoViagem` (
    ...
    `StatusSolicitacao_idStatusViagem` INTEGER NOT NULL,
    `Viagem_idViagem` INTEGER NOT NULL,
    ...
    INDEX `fk_solviagem_status`(`StatusSolicitacao_idStatusViagem`),
...
CREATE TABLE `StatusCarro` (
    `idStatusCarro` INTEGER NOT NULL AUTO_INCREMENT,
    `statusCarro` ENUM('DISPONIVEL', 'EM USO', 'EM MANUTENCAO') NOT NULL,
...
CREATE TABLE `TipoCarro` (
    `idTipoCarro` INTEGER NOT NULL AUTO_INCREMENT,
    `nome` ENUM('VAN', 'MINIVAN', 'HATCH', 'SEDAN', 'SUV') NOT NULL,
...
CREATE TABLE `TipoSolicitacao` (
    `idTipoSolicitacao` INTEGER NOT NULL AUTO_INCREMENT,
...
-- AddForeignKey
ALTER TABLE `Carro` ADD CONSTRAINT `fk_carro_status` FOREIGN KEY (`StatusCarro_idStatusCarro`) REFERENCES `StatusCarro`(`idStatusCarro`) ON DELETE NO ACTION ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `Carro` ADD CONSTRAINT `fk_carro_tipo` FOREIGN KEY (`TipoCarro_idTipoCarro`) REFERENCES `TipoCarro`(`idTipoCarro`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE `IntervaloDatas` ADD CONSTRAINT `fk_intervalo_curso` FOREIGN KEY (`Curso_idCurso`) REFERENCES `Curso`(`idCurso`) ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `IntervaloDatas` ADD CONSTRAINT `fk_intervalo_evento` FOREIGN KEY (`Evento_idEvento`) REFERENCES `Evento`(`idEvento`) ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE `MensagemOuvidoria` ADD CONSTRAINT `fk_msg_categoria` FOREIGN KEY (`CategoriaMensagemOuvidoria_idCategoriaMensagemOuvidoria`) REFERENCES `CategoriaMensagemOuvidoria`(`idCategoriaMensagemOuvidoria`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE `Solicitacao` ADD CONSTRAINT `fk_solicitacao_tipo` FOREIGN KEY (`TipoSolicitacao_idTipoSolicitacao`) REFERENCES `TipoSolicitacao`(`idTipoSolicitacao`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE `SolicitacaoViagem` ADD CONSTRAINT `fk_solviagem_status` FOREIGN KEY (`StatusSolicitacao_idStatusViagem`) REFERENCES `StatusSolicitacao`(`idStatusViagem`) ON DELETE NO ACTION ON UPDATE NO ACTION;
